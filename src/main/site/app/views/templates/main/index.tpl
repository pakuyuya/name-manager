<header class="p-header u-flex" id="header">
    <div class="u-p95">
        ヒューライツ大阪名簿データベース
    </div>
    <!-- ボタン -->
    <div class="p-header-buttons u-p5">
        <button class="header"><span class="icon-gear-white"></span></button>
        <div class="p-header-menu">
            <div class="p-header-menu-row">設定</div>
            <div class="p-header-menu-row">ログアウト</div>
        </div>
    </div>
</header>
<div id="main">
